        ...
        if(!isLastItem(position)) {
            ...
            holder.item_selected.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnItemClickListener.onItemClick(position, getItemViewType(position));
                }
            });
            holder.item_selected.setOnLongClickListener(new View.OnLongClickListener(){

                @Override
                public boolean onLongClick(View v) {
                    PlanDeleteDialog dialog = new PlanDeleteDialog(list.get(position));
                    dialog.setNoticDialogListener(new PlanDeleteDialog.NoticeDialogListener() {
                        @Override
                        public void onDialogPositiveClick(long plan_id) {
                            deletePlan(plan_id);
                        }
                    });
